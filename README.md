...
由 FastAPI 后端和 Android 原生客户端组成。Serana 以对话为入口，按需调用浏览器、记忆、Skill 和工具，把“回答问题”逐步推进到“处理事情”。
...
| Skill | Serana 标准 `SKILL.md` / `skill.json`，SkillHub 市场，Python/Script Runtime |
...
- [后端演进路线图](docs/SERANA_BACKEND_ROADMAP.md)
